[![Tests](https://github.com/AlexandrSkv/python-core-homework/actions/workflows/python-app.yml/badge.svg?branch=master)](https://github.com/AlexandrSkv/python-core-homework/actions/workflows/python-app.yml)
